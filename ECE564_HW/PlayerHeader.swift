...
class PlayerHeader: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        let myAttributes = [NSAttributedString.Key.font: UIFont(name: "Marker Felt", size: 35)!, .foregroundColor: UIColor(red: 50/255, green: 80/255, blue: 255/255, alpha: 1.00), NSAttributedString.Key.shadow: myShadow] as [NSAttributedString.Key : Any]
